...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { description: @gallery.description, name: @gallery.name, owner_id: @gallery.owner_id, owner_type: @gallery.owner_type }
    end
  ...
  test "should update gallery" do
    patch :update, id: @gallery, gallery: { description: @gallery.description, name: @gallery.name, owner_id: @gallery.owner_id, owner_type: @gallery.owner_type }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
